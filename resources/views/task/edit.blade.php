                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="input-group">
                                          {!! Form::select('adviser',App\User::where('role','adviser')->whereNotIn('id',[Auth::user()->id])->lists('first_name','id')
                                       ,$projects->coadviser[0]->id ,['class'=>'form-control input-md','id'=>'coadviser-select']) !!}
