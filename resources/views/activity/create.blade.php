                    ...
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                ...
                                ?>
                                <input id="name"  type="text" value="{!! $project[0]->name !!}"  id="project" class="form-control input-md" readonly >
                                @else 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="name" name="activity_name" type="text"  class="form-control input-md">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="name" name="task_name" type="text"  class="form-control input-md">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-daterange input-group" id="datepicker">
                                    <input type="text" class="input-sm form-control" name="task_start" />
                                    <span class="input-group-addon">ถึง</span>
                                    <input type="text" class="input-sm form-control" name="task_finish" />
                                </div>
                            </div>
                        </div>
...
$('#datepicker').datepicker({
    ...
    language: "th",
    todayHighlight: true,
    startDate: "{!! $project[0]->start !!}",
    endDate: "{!! $project[0]->finish !!}",
