    ...
    <div class="row">
        <div class="col-md-10">
            <div class="panel panel-default">
                ...
                {!! Form::open(['route'=>'project.create','class'=>'form-horizontal']) !!}
                 {!! Form::hidden('primary_adviser_id',Auth::user()->id) !!}
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input id="name" name="name" value="" type="text" placeholder="ระบบจัดการร้านอาหาร" class="form-control input-md">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-6">     
                                {!! Form::select('status',['1'=>'เริ่มดำเนินงาน',"2"=>'เสร็จสมบูรณ์','3'=>'ไม่ผ่าน',''],'',['class'=>'form-control chosen'])!!}
                                   </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">                     
                                    <textarea class="form-control" col="70" rows="10" id="detail" name="detail"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input id="start" name="start" value="" type="text" placeholder="" class="singledatepicker form-control input-md">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="input-group">
                                       ...
                                       ,'' ,['class'=>'form-control input-md','id'=>'coadviser-select']) !!}
