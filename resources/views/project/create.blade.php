                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input id="name" name="name" value="" type="text"
                                     placeholder="ระบบจัดการร้านอาหาร" class="form-control input-md validate[required]">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-6">     
                                {!! Form::select('status',['1'=>'เริ่มดำเนินงาน',"2"=>'เสร็จสมบูรณ์','3'=>'ไม่ผ่าน',''],'',['class'=>'form-control chosen validate[required]'])!!}
                                   </div>
